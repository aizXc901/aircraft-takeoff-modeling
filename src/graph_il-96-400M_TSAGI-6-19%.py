...
Cx = 0.0514         # Коэффициент продольного сопротивления (лобовое сопротивление)
Cy = 0.710          # Коэффициент поперечного сопротивления (подъемная сила)
...
plt.title("График дистанции взлета Ил-96-400М (Профиль ЦАГИ-6-19%)")
plt.legend()
plt.grid(True)
plt.show()