...
Cx = 0.052          # Коэффициент продольного сопротивления (лобовое сопротивление)
Cy = 0.8            # Коэффициент поперечного сопротивления (подъемная сила)
...
plt.title("График дистанции взлета Ил-96-400М (Профиль A-18%)")
plt.legend()
plt.grid(True)
plt.show()
