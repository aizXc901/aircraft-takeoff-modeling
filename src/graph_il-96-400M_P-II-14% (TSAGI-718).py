...
# Данные о самолете
mass = 270000       # Масса самолета, кг
thrust = 686000     # Общая тяга всех двигателей, Н
Cx = 0.0520         # Коэффициент продольного сопротивления (лобовое сопротивление)
Cy = 0.780          # Коэффициент поперечного сопротивления (подъемная сила)
area = 391          # Площадь крыла, м²
...
plt.title("График дистанции взлета Ил-96-400М (Профиль P-II-14% (ЦАГИ-718))")
plt.legend()
plt.grid(True)
plt.show()