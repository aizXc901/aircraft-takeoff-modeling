...
Cx = 0.0313         # Коэффициент продольного сопротивления (лобовое сопротивление)
Cy = 0.571          # Коэффициент поперечного сопротивления (подъемная сила)
...
plt.title("График дистанции взлета Ил-96-300 (Профиль В-12%)")
plt.legend()
plt.grid(True)
plt.show()