...
Cx = 0.069          # Коэффициент продольного сопротивления (лобовое сопротивление)
Cy = 0.93           # Коэффициент поперечного сопротивления (подъемная сила)
...
plt.title("График дистанции взлета SJ-100 (Профиль A-18%)")
plt.legend()
plt.grid(True)
plt.show()