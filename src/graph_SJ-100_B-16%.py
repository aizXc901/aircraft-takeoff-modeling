...
Cx = 0.0460          # Коэффициент продольного сопротивления (лобовое сопротивление)
Cy = 0.7             # Коэффициент поперечного сопротивления (подъемная сила)
...
plt.title("График дистанции взлета SJ-100 (Профиль B-16%)")
plt.legend()
plt.grid(True)
plt.show()